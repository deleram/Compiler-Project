...
public class FunctionCraftLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "INT_VAL", "FLOAT_VAL", "STRING_VAL", "DOT", "MULT", "MOD", "PLUS", 
			"MINUS", "DIV", "DMINUS", "DPLUS", "LES", "GRT", "COLON", "LESE", "GRTE", 
			"AND", "OR", "NOT", "APPEND", "ASSIGN", "EQUAL", "NEQUAL", "PLUS_ASSIGN", 
